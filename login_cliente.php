...
<?php
  ...
  ?>
    ...
    <div class="container">
        <h1>Olá, seja bem-vindo(a)!! Cliente Faça seu Cadastro</h1>
        <form action="processa_login_cliente.php" method="post">
            <div class="col-4">
            ...
            <a href="cad_cliente.php" class="btn btn-warning">Cadastrar-se</a>
        </form>
    </div>
</body>
